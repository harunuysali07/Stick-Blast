...
public static class DataManager
{
    ...
    private static List<ShapeData> _allShapes;
    
    public static List<ShapeData> AllShapes => _allShapes ??= Resources.LoadAll<ShapeData>("Game Resources/Shape Data").ToList();
